<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?=base_url();?>room_transaction/save_new" method="post">
                <div class="form-group">
                    <label for="select_employee">Pilih Pegawai</label>
                    <select class="form-control" name="employee_id" id="select_employee">
                        <option value="" selected disabled>Pilih</option>
                        <?php foreach($employee as $emp):?>
                            <?php if($emp['room_id'] == null): ?>
